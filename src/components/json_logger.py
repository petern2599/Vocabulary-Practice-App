...
class JSONLogger():
    def __init__(self):
        ...
        json_path = self.check_current_month_log_folder_exists(year_path)
    ...
    def check_current_month_log_folder_exists(self,path):
        ...
        if os.path.exists(new_path):
            ...
            data = {"{}".format(day):{"correct":0, "incorrect":0}}
    ...
    def append_daily_stats(self,correct,incorrect):
        ...
        with open(json_path,'r+') as file:
            ...
            if day in file_data:
                ...
                file_data[day]= {"correct":correct_stat + correct, "incorrect":incorrect_stat+incorrect}
                file.seek(0)
                json.dump(file_data,file,indent=4)
            else:
                print("Adding new entry in log file...")
                file_data[day] = {"correct":correct, "incorrect":incorrect}
                file.seek(0)
                json.dump(file_data,file,indent=4)
